...
CREATE TABLE IF NOT EXISTS \`homepage\`.\`trial_applications\` (
  ...
  \`consultation_direction\`   VARCHAR(64)  DEFAULT NULL COMMENT '咨询方向',
  \`wechat_id\`                VARCHAR(64)  DEFAULT NULL COMMENT '微信号',
  \`preferred_contact_channel\` VARCHAR(32)  DEFAULT NULL COMMENT '希望联系渠道',
  \`estimated_budget\`         VARCHAR(128) DEFAULT NULL COMMENT '预计预算',
